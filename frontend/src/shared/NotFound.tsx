...
export default function NotFound ({ message, title }: INotFound) {
    ...
    return <div className="my-28 w-1/3 mx-auto text-center space-y-3">
        ...
        <div className="flex border-2 border-gray-500 justify-center mt-5 flex-wrap p-4 space-x-4 space-y-2">
            {categories && categories.map(category => <CategoryItem category={category} />)}
        </div>
    </div>
}
